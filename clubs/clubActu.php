<div id="clubActu.php">
	...
	<br>
	<center>
	<img src="images/clubs/clubActu/imageExemple.jpg" name="imageExemple.jpg" class="img_club" alt="image" class="col-lg-4" id="img1ClubActu" onload="displayHideImg(this.id)">
	<img src="images/clubs/clubActu/imageExemple.jpg" name="imageExemple.jpg" class="img_club" alt="image" class="col-lg-4" id="img2ClubActu" onload="displayHideImg(this.id)">
	<img src="images/clubs/clubActu/imageExemple.jpg" name="imageExemple.jpg" class="img_club" alt="image" class="col-lg-4" id="img3ClubActu" onload="displayHideImg(this.id)">
	</center>
