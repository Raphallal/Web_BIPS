<div id="popsgames.php">
	...
	<br>
	<center>
	<img src="images/clubs/popsgames/imageExemple.jpg" name="imageExemple.jpg" class="img_club" alt="image" class="col-lg-4" id="img1Bds">
	<img src="images/clubs/popsgames/imageExemple.jpg" name="imageExemple.jpg" class="img_club" alt="image" class="col-lg-4" id="img2Bds">
	<img src="images/clubs/popsgames/imageExemple.jpg" name="imageExemple.jpg" class="img_club" alt="image" class="col-lg-4" id="img3Bds">
	</center>
