<div id="bds.php">
	...
	<br>
	<center>
	<img src="images/clubs/bds/imageExemple.jpg" name="imageExemple.jpg" class="img_club" alt="image" class="col-lg-4" id="img1Bds">
	<img src="images/clubs/bds/imageExemple.jpg" name="imageExemple.jpg" class="img_club" alt="image" class="col-lg-4" id="img2Bds">
	<img src="images/clubs/bds/imageExemple.jpg" name="imageExemple.jpg" class="img_club" alt="image" class="col-lg-4" id="img3Bds">
	</center>
	
	<div id="gestionImgBds" class="non-visible">
		<select id="selectImg1Bds" class="col-lg-2 col-lg-offset-1" style="display:inline-block" onchange="changeImg('img1Bds','images/clubs/bds/',document.getElementById('selectImg1Bds').value)">
			<option value="imageExemple.jpg">imageExemple.jpg</option>
		</select>
			
		<select id="selectImg2Bds" class="col-lg-2 col-lg-offset-2" style="display:inline-block" onchange="changeImg('img2Bds','images/clubs/bds/',document.getElementById('selectImg2Bds').value)">
			<option value="imageExemple.jpg">imageExemple.jpg</option>
		</select>

		<select id="selectImg3Bds" class="col-lg-2 col-lg-offset-2" style="display:inline-block" onchange="changeImg('img3Bds','images/clubs/bds/',document.getElementById('selectImg3Bds').value)">
			<option value="imageExemple.jpg">imageExemple.jpg</option>
		</select>
