<div id="spips.php">
	...
	<br>
	<center>
	<img src="images/clubs/spips/imageExemple.jpg" name="imageExemple.jpg" class="img_club" alt="image" class="col-lg-4" id="img1Spips" onload="displayHideImg(this.id)">
	<img src="images/clubs/spips/imageExemple.jpg" name="imageExemple.jpg" class="img_club" alt="image" class="col-lg-4" id="img2Spips" onload="displayHideImg(this.id)">
	<img src="images/clubs/spips/imageExemple.jpg" name="imageExemple.jpg" class="img_club" alt="image" class="col-lg-4" id="img3Spips" onload="displayHideImg(this.id)">
	</center>
