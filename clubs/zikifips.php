<div id="zikifips.php">
	...
	<br>
	<center>
	<img src="images/clubs/zikifips/imageExemple.jpg" name="imageExemple.jpg" class="img_club" alt="image" class="col-lg-4" id="img1Zikifips">
	<img src="images/clubs/zikifips/imageExemple.jpg" name="imageExemple.jpg" class="img_club" alt="image" class="col-lg-4" id="img2Zikifips">
	<img src="images/clubs/zikifips/imageExemple.jpg" name="imageExemple.jpg" class="img_club" alt="image" class="col-lg-4" id="img3Zikifips">
	</center>
