<div id="zikifips.php">
	...
	<div id="gestionImgZikifips" class="non-visible">
	    ...
	    <form method="post" action="uploadImage.php" enctype="multipart/form-data" id="formUp" style="display:inline-block"> 
			...
			<input type="text" name="directory" value="images/clubs/zikifips/" class="non-visible">        
