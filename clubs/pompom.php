<div id="pompom.php">
	...
	<br>
	<center>
	<img src="images/clubs/pompom/imageExemple.jpg" name="imageExemple.jpg" class="img_club" alt="image" class="col-lg-4" id="img1Bds" onload="displayHideImg(this.id)">
	<img src="images/clubs/pompom/imageExemple.jpg" name="imageExemple.jpg" class="img_club" alt="image" class="col-lg-4" id="img2Bds" onload="displayHideImg(this.id)">
	<img src="images/clubs/pompom/imageExemple.jpg" name="imageExemple.jpg" class="img_club" alt="image" class="col-lg-4" id="img3Bds" onload="displayHideImg(this.id)">
	</center>
	
	<div id="gestionImgBds" class="non-visible">
		<select id="selectImg1Bds" class="col-lg-2 col-lg-offset-1" style="display:inline-block" onchange="changeImg('img1Bds','images/clubs/pompom/',document.getElementById('selectImg1Bds').value)">
			<option value="imageExemple.jpg">imageExemple.jpg</option>
		</select>
			
		<select id="selectImg2Bds" class="col-lg-2 col-lg-offset-2" style="display:inline-block" onchange="changeImg('img2Bds','images/clubs/pompom/',document.getElementById('selectImg2Bds').value)">
			<option value="imageExemple.jpg">imageExemple.jpg</option>
		</select>

		<select id="selectImg3Bds" class="col-lg-2 col-lg-offset-2" style="display:inline-block" onchange="changeImg('img3Bds','images/clubs/pompom/',document.getElementById('selectImg3Bds').value)">
			<option value="imageExemple.jpg">imageExemple.jpg</option>
		</select>
	    ...
	    <form method="post" action="uploadImage.php" enctype="multipart/form-data" id="formUp" style="display:inline-block"> 
			...
			<input type="text" name="directory" value="images/clubs/pompom/" class="non-visible">        
