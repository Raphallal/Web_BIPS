<div id="cohesion.php">
	...
	<br>
	<center>
	<img src="images/clubs/cohesion/imageExemple.jpg" name="imageExemple.jpg" class="img_club" alt="image" class="col-lg-4" id="img1Cohesion" onload="displayHideImg(this.id)">
	<img src="images/clubs/cohesion/imageExemple.jpg" name="imageExemple.jpg" class="img_club" alt="image" class="col-lg-4" id="img2Cohesion" onload="displayHideImg(this.id)">
	<img src="images/clubs/cohesion/imageExemple.jpg" name="imageExemple.jpg" class="img_club" alt="image" class="col-lg-4" id="img3Cohesion" onload="displayHideImg(this.id)">
	</center>
