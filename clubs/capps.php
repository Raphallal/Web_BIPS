<div id="capps.php">
	...
	<br>
	<center>
	<img src="images/clubs/capps/imageExemple.jpg" name="imageExemple.jpg" class="img_club" alt="image" class="col-lg-4" id="img1Capps" onload="displayHideImg(this.id)">
	<img src="images/clubs/capps/imageExemple.jpg" name="imageExemple.jpg" class="img_club" alt="image" class="col-lg-4" id="img2Capps" onload="displayHideImg(this.id)">
	<img src="images/clubs/capps/imageExemple.jpg" name="imageExemple.jpg" class="img_club" alt="image" class="col-lg-4" id="img3Capps" onload="displayHideImg(this.id)">
	</center>
