...
<section class="sectionClub">
	...
	<span id="bds_contenu" class="non-visible">
			<input type="button" class="non-visible" value="Modifier" id="modifBds" onclick="modifier(this.value, 'bds.php')" />
			<br>
		<?php include("clubs/bds.php"); ?>
	</span>
	<span id="capps_contenu" class="non-visible">
			<input type="button" class="non-visible" value="Modifier" id="modifCapps" onclick="modifier(this.value, 'capps.php')" />
			<br>
		<?php include("clubs/capps.php"); ?>
	</span>
	<span id="cinefips_contenu" class="non-visible">
			<input type="button" class="non-visible" value="Modifier" id="modifCine" onclick="modifier(this.value, 'cinefips.php')" />
			<br>
		<?php include("clubs/cinefips.php"); ?>
	</span>
	<span id="clubactus_contenu" class="non-visible">
			<input type="button" class="non-visible" value="Modifier" id="modifClubActu" onclick="modifier(this.value, 'clubActu.php')" />
			<br>
		<?php include("clubs/clubactu.php"); ?>
	</span>
	<span id="cohesion_contenu" class="non-visible">
			<input type="button" class="non-visible" value="Modifier" id="modifCohesion" onclick="modifier(this.value, 'cohesion.php')" />
			<br>
		<?php include("clubs/cohesion.php"); ?>
	</span>
	<span id="journal_contenu" class="non-visible">
			<input type="button" class="non-visible" value="Modifier" id="modifJournal" onclick="modifier(this.value, 'journal.php')" />
			<br>
		<?php include("clubs/journal.php"); ?>
	</span>
	<span id="kfet_contenu" class="non-visible">
			<input type="button" class="non-visible" value="Modifier" id="modifKfet" onclick="modifier(this.value, 'kfet.php')" />
			<br>
		<?php include("clubs/kfet.php"); ?>
	</span>
	<span id="pompom_contenu" class="non-visible">
			<input type="button" class="non-visible" value="Modifier" id="modifPompom" onclick="modifier(this.value, 'pompom.php')" />
			<br>
		<?php include("clubs/pompom.php"); ?>
	</span>
	<span id="popsgames_contenu" class="non-visible">
			<input type="button" class="non-visible" value="Modifier" id="modifPopsgames" onclick="modifier(this.value, 'popsgames.php')" />
			<br>
		<?php include("clubs/popsgames.php"); ?>
	</span>
	<span id="spips_contenu" class="non-visible">
			<input type="button" class="non-visible" value="Modifier" id="modifSpips" onclick="modifier(this.value, 'spips.php')" />
			<br>
		<?php include("clubs/spips.php"); ?>
	</span>
	<span id="zikifips_contenu" class="non-visible">
			<input type="button" class="non-visible" value="Modifier"id="modifZikifips" onclick="modifier(this.value, 'zikifips.php')" />
			<br>
